...
TECHNO_IMG = "https://telegra.ph/file/ac438b4ae4f46e7bba82a.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/jamessupportgroup")],
                                                                                   [InlineKeyboardButton(text="ADD JAMES BOT TO YOUR GROUP",
                                                                       url="t.me/{}?startgroup=true".format(bot.username)),
                                                                                   InlineKeyboardButton(text="Source Code",
                                                                       url="https://github.com/VAMPIREJAMES/JAMESBOT")
                                                                                 ]]))

    else:
        update.effective_message.reply_text("BAAP IS BACK")
